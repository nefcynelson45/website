                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img height="500" width="200" src="https://wallpapercave.com/wp/wp1821854.png" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img height="500" width="200" src="https://images-na.ssl-images-amazon.com/images/I/81yhT8ouG9L._RI_.jpg" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img  height="500" width="200" src="  https://cdn.hipwallpaper.com/i/68/98/4rqSlp.jpg" class="d-block w-100" alt="...">
                      </div>
                    </div>
